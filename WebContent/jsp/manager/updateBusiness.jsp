...
<div class="layui-container">
	<form class="layui-form" lay-filter="updateBusiness" id="updateBusiness">
	<div class="layui-form-item">
			<label class="layui-form-label">企业编号</label>
			<div class="layui-input-inline">
				<input type="text" name="bsid" class="layui-input" placeholder="请输入想要更改企业的企业编号">
			</div>
		</div>
		<div class="layui-form-item">
...
<script type="text/javascript">
	layui.use(["form","jquery"],function(){
		...
		form.on("submit(save)",function(data){
			var url="updateBusiness.do";			
			$.post(url,data.field,function(txt){
				if(txt=="ok"){
					alert("添加成功");
					$("#updateBusiness")[0].reset(); 
					form.render();
				} 
				else {
					alert("添加失败");
