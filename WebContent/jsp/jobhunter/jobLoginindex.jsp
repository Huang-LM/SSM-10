	...
	<div class="layui-layout layui-layout-admin ">
		...
		<div class="layui-header layui-bg-cyan nav">
			...
			<ul class="layui-nav layui-layout-left" lay-filter="menu">
				<li class="layui-nav-item layui-this"><a href="jsp/jobhunter/jobLoginindex.jsp" >首页</a>
				...
				<div class="layui-row">
					...
					<div class="layui-col-md8">
						<div class="layui-form" action="">
							<table>
								<tr>
									<td><input type="text" name="search" autocomplete="off" placeholder="请输入职业名称" class="layui-input search-input" lay-verify="required"></td>
